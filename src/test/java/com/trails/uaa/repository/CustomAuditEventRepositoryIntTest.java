package com.trails.uaa.repository;

import com.trails.uaa.TrailsUaaApp;
import com.trails.uaa.config.Constants;
import com.trails.uaa.config.audit.AuditEventConverter;
import com.trails.uaa.domain.PersistentAuditEvent;
...
import static com.trails.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
